...
var VisionScanner = function (_a) {
    ...
    var _k = react.useState(true), isEdgeDetectionActive = _k[0], setIsEdgeDetectionActive = _k[1];
    var _l = react.useState(true), isLoading = _l[0], setIsLoading = _l[1];
    var _m = react.useState(true), isEmbedded = _m[0], setIsEmbedded = _m[1];
    ...
    var _p = react.useState(false), isAdjustmentMode = _p[0], setIsAdjustmentMode = _p[1];
    var _q = react.useState(null), capturedImage = _q[0], setCapturedImage = _q[1];
    var _r = react.useState(false), imageLoaded = _r[0], setImageLoaded = _r[1];
    var _s = react.useState(null), adjustedCorners = _s[0], setAdjustedCorners = _s[1];
    var _t = react.useState(null), activeCornerIndex = _t[0], setActiveCornerIndex = _t[1];
    var _u = react.useState(false), isDragging = _u[0], setIsDragging = _u[1];
    // Stop stream
