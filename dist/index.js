...
var VisionScanner = function (_a) {
    ...
    var _k = react.useState(false), isEdgeDetectionActive = _k[0], setIsEdgeDetectionActive = _k[1];
    ...
    return (jsxRuntime.jsxs("div", { className: "vision-scanner", children: [jsxRuntime.jsx("video", { ref: videoRef, autoPlay: true, playsInline: true, muted: true, className: "vision-scanner-video" }), jsxRuntime.jsx("canvas", { ref: canvasRef, className: "vision-scanner-canvas", style: { display: 'none' } }), jsxRuntime.jsx("canvas", { ref: edgeCanvasRef, className: "vision-scanner-edge-canvas", style: {
                    position: 'absolute',
                    top: 0,
                    left: 0,
                    width: '100%',
                    ...
                    pointerEvents: 'none'
                } }), isLoading && (jsxRuntime.jsxs("div", { className: "vision-scanner-loading", children: [jsxRuntime.jsx("div", { className: "loading-spinner" }), jsxRuntime.jsx("div", { className: "loading-text", children: "Initializing camera..." })] })), jsxRuntime.jsxs("div", { className: "vision-scanner-controls", children: [jsxRuntime.jsx("button", { onClick: capture, className: "vision-scanner-button primary-button", disabled: !isCameraReady, children: "Scan Document" }), cameraCount > 1 && (jsxRuntime.jsx("button", { onClick: switchCamera, className: "vision-scanner-button", children: "Switch Camera" })), hasTorch && (jsxRuntime.jsx("button", { onClick: toggleTorch, className: "vision-scanner-button", children: torchOn ? "Light Off" : "Light On" })), jsxRuntime.jsx("button", { onClick: toggleEdgeDetection, disabled: !isCameraReady || !isOpenCVReady, className: "vision-scanner-button ".concat(isEdgeDetectionActive ? 'active-button' : ''), children: isEdgeDetectionActive ? "Hide Edges" : "Show Edges" })] }), !isOpenCVReady && isCameraReady && (jsxRuntime.jsx("div", { className: "vision-scanner-status", children: jsxRuntime.jsx("div", { className: "status-message", children: "Loading vision features..." }) }))] }));
};
